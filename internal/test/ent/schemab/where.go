...
func ID(id int64) predicate.SchemaB {
	return predicate.SchemaB(sql.FieldEQ(FieldID, id))
}
...
func IDNEQ(id int64) predicate.SchemaB {
	return predicate.SchemaB(sql.FieldNEQ(FieldID, id))
}

// IDIn applies the In predicate on the ID field.
func IDIn(ids ...int64) predicate.SchemaB {
	return predicate.SchemaB(sql.FieldIn(FieldID, ids...))
}

// IDNotIn applies the NotIn predicate on the ID field.
func IDNotIn(ids ...int64) predicate.SchemaB {
	return predicate.SchemaB(sql.FieldNotIn(FieldID, ids...))
}

// IDGT applies the GT predicate on the ID field.
func IDGT(id int64) predicate.SchemaB {
	return predicate.SchemaB(sql.FieldGT(FieldID, id))
}

// IDGTE applies the GTE predicate on the ID field.
func IDGTE(id int64) predicate.SchemaB {
	return predicate.SchemaB(sql.FieldGTE(FieldID, id))
}

// IDLT applies the LT predicate on the ID field.
func IDLT(id int64) predicate.SchemaB {
	return predicate.SchemaB(sql.FieldLT(FieldID, id))
}

// IDLTE applies the LTE predicate on the ID field.
func IDLTE(id int64) predicate.SchemaB {
	return predicate.SchemaB(sql.FieldLTE(FieldID, id))
}

// And groups predicates with the AND operator between them.
func And(predicates ...predicate.SchemaB) predicate.SchemaB {
	return predicate.SchemaB(func(s *sql.Selector) {
		s1 := s.Clone().SetP(nil)
