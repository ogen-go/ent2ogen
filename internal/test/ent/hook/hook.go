...
import (
	...
	"github.com/ogen-go/ent2ogen/internal/test/ent"
)

// The SchemaAFunc type is an adapter to allow the use of ordinary
// function as SchemaA mutator.
type SchemaAFunc func(context.Context, *ent.SchemaAMutation) (ent.Value, error)
...
// function as SchemaB mutator.
type SchemaBFunc func(context.Context, *ent.SchemaBMutation) (ent.Value, error)
